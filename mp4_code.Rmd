...
```
  ...
  In terms of pitchers that haven't made the Hall of Fame, the one that really sticks out like a sore thumb is Roger Clemens. In terms of overall numbers, his Wins and ERA most resemble Greg Maddux, a historically great pitcher and unquestionable Hall of Famer. 
  ...
  For batters, there are a few more interesting cases. Obviously, Barry Bonds is the first name that jumps off the page. The major league leader in home runs with almost a .300 AVG was pretty incredible and fearsome as a hitter. Sure, the main reason he is not in the Hall of Fame is because of the steroids issue, but statistically speaking he deserves to be there. 
