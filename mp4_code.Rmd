...
hiit_1 <- plot_ly(hitters, x = ~yearID, color = I("black")) %>%
  add_markers(y = ~HR, text = ~paste('Player: ', nameFirst, "", nameLast)) %>%
...
hiit_2 <- plot_ly(hitters, x = ~yearID, color = I("black")) %>%
  add_markers(y = ~AVG, text = ~paste('Player: ', nameFirst, "", nameLast)) %>%
...
hiit_3 <- plot_ly(hitters, x = ~yearID, color = I("black")) %>%
  add_markers(y = ~SB, text = ~paste('Player: ', nameFirst, "", nameLast)) %>%
...
hiit_4 <- plot_ly(hitters, x = ~yearID, color = I("black")) %>%
  add_markers(y = ~SLG, text = ~paste('Player: ', nameFirst, "", nameLast)) %>%
  add_lines(y = ~fitted(loess(SLG ~ yearID)),
            line = list(color = '#07A4B5'),
            name = "Loess Smoother", showlegend = FALSE) %>%
  layout(xaxis = list(title = 'Year'),
         yaxis = list(title = 'SLG'))
subplot(hiit_1, hiit_2, hiit_3 , hiit_4 , nrows = 2, margin = 0.06, heights = c(0.55, 0.45), titleY = TRUE, titleX = TRUE)
```
