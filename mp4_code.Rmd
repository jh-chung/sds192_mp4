...
non_hof_pitch <- plot_ly(pitchers_not_inducted, x = ~ERA, y = ~W, type = 'scatter', mode = 'markers',
        text = ~paste('Player: ', nameFirst , "" , nameLast, yearID)) %>%
          layout(title = "Pitchers Not Inducted" , xaxis = era_x , yaxis = wins_y)
```

  The graphs p_arranged and h_arranged allow us to respectively compare ERA and W for HOF vs. non-HOF pitchers, as well as AVG and HRs for HOF vs. non-HOF hitters. In terms of pitchers that haven't made the Hall of Fame, the one that really sticks out like a sore thumb is Roger Clemens. In terms of overall numbers, his Wins and ERA most resemble Greg Maddux, a historically great pitcher and unquestionable Hall of Famer. For batters, there are a few more interesting cases. Obviously, Barry Bonds is the first name that jumps off the page. The major league leader in home runs with almost a .300 AVG was pretty incredible and fearsome as a hitter. Sure, the main reason he is not in the Hall of Fame is because of the steroids issue, but statistically speaking he deserves to be there. Another interesting case is Edgar Martinez. His average of .312 and 309 career home runs put him statistically similar to Hall of Famers like George Brett, Ryne Sandberg, and Ivan Rodrgiuez. The main knock against Edgar is not anything to do with steroids, but instead that he spent the majority of his career as a designated hitter, meaning he rarely played the field and didn't contribute defensively. However, again from a statistical perspective, it appears he belongs in the Hall of Fame. Edgar was one of the most feared hitters of his era, playing a memorable role in both the Mariners 1995 postseason run, as well as their historic 2001 116-win season. It seems unfortunate that his reputation of not playing the field much will prevent a player that is one of the better hitters in this generation from reaching the esteemed Hall of Fame.
